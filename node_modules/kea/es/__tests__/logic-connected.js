...
test('connected props and actions get passed, reducers get added to the store', function () {
  var scenesReducer = keaReducer('scenes');
...
test('connected props can be used as selectors', function () {
  ...
  var firstLogic = kea({
    ...
    reducers: function reducers(_ref7) {
      ...
      return {
        name: ['chirpy', PropTypes.string, (_ref8 = {}, _ref8[actions.updateName] = function (state, payload) {
          return payload.name;
        }, _ref8)]
      };
    }
...
test('can get everything with *', function () {
  ...
  var firstLogic = kea({
    ...
    reducers: function reducers(_ref11) {
      ...
      return {
        name: ['chirpy', PropTypes.string, (_ref12 = {}, _ref12[actions.updateName] = function (state, payload) {
          return payload.name;
        }, _ref12)]
      };
    }
