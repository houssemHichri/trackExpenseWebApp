...
function injectSagasIntoClass(Klass, input, output) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return (0, _effects.select)(key ? selectors[key] : selector, this.props);
      ...
      (0, _keys2.default)(output.actions || {}).forEach(function (actionKey) {
        if (key) {
          sagaActions[actionKey] = function () {
            ...
            return (0, _assign2.default)({}, createdAction, {
              payload: (0, _assign2.default)({ key: key }, createdAction.payload)
            });
          };
  ...
  Klass.prototype.componentWillUnmount = function () {
    ...
    if (this._keaRunningSaga) {
      (0, _saga.cancelSaga)(this._keaRunningSaga);
    }
